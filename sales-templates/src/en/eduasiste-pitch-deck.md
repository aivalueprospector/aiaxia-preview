...
- Not what grade they got. What they learned.
- {{Prospect Name}}, this is the question we want to answer.

::: notes
Don't answer the question. Wait 3 seconds. Let the room feel it. Everyone here has lived the gap between "got a B" and "actually understood it." Drop in {{Prospect Name}} to make it personal.
:::

## The problem with every learning app you've tried

- Report cards come weeks late
- Parent dashboards show scores, not understanding
- Homework apps add friction, not signal
...
::: notes
This slide converts privacy-skeptical parents. Don't skip it, even when you're short on time. For teen parents and ethics-forward schools, this is the whole sale.
:::
...
::: notes
Make it sound like a weekend experiment, not a year commitment. The trial sells itself once they see the first auto-summary. Close on the demo: confirm {{Demo Date}} before you leave the room. Leave them {{Rep Name}} / {{Rep Email}} to follow up.
:::
